...
placeShips PROC
    ...
    MOV WORD PTR [BX][DI],'H'
    MOV WORD PTR [BX-22][DI],'H'
    MOV WORD PTR [BX+22][DI],'H'
    ...
    PLACE_ENCOURACADO:
        ...
        MOV CX,4
        CMP DL,4
        JA OUTROSENTIDO_ENCOURACADO
        COLOCAR_ENCOURACADO:
            MOV WORD PTR [BX][DI],'E'
            ADD DI,2
            LOOP COLOCAR_ENCOURACADO
            POP CX
            RET
        OUTROSENTIDO_ENCOURACADO:
            MOV WORD PTR [BX][DI],'E'
            SUB DI,2
            LOOP OUTROSENTIDO_ENCOURACADO
            POP CX
            RET
    ...
    PLACE_FRAGATA:
        ...
        MOV CX,3
        CMP DL,4
        JA OUTROSENTIDO_FRAGATA
        COLOCAR_FRAGATA:
            MOV WORD PTR [BX][DI],'F'
            ADD DI,2
            LOOP COLOCAR_FRAGATA
            POP CX
            RET
        OUTROSENTIDO_FRAGATA:
            MOV WORD PTR [BX][DI],'F'
            SUB DI,2
            LOOP OUTROSENTIDO_FRAGATA
            POP CX
            RET
    ...
    PLACE_SUBMARINO:
        ...
        MOV CX,2
        CMP DL,4
        JA OUTROSENTIDO_SUBMARINO
        COLOCAR_SUBMARINO:
            MOV WORD PTR [BX][DI],'S'
            ADD DI,2
            LOOP COLOCAR_SUBMARINO
            POP CX
            RET
        OUTROSENTIDO_SUBMARINO:
            MOV WORD PTR [BX][DI],'S'
            SUB DI,2
            LOOP OUTROSENTIDO_SUBMARINO
            POP CX
            RET
